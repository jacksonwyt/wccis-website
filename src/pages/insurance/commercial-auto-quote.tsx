...
const CommercialAutoQuotePage = () => {
  ...
  const onSubmit = (data: CommercialAutoQuote) => {
    ...
    try {
      ...
      const subject = `Commercial Auto Quote Request - ${data.businessName}`;
      const body = `
...
------
Please remember to attach the required documents (Driver's Licenses, Vehicle Registrations) to this email before sending.
      `.trim();
      ...
      setSuccess('Your email app should open shortly. Please attach required documents and send the message.');
      reset();
    } catch (error: any) {
