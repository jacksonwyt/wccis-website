        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-white mb-3">Premises Liability</h3>
              <p className="text-gray-300">Protection for injuries or property damage that occur on your business premises.</p>
            </div>
            
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-white mb-3">Products Liability</h3>
              <p className="text-gray-300">Coverage for injuries or damage caused by products you sell or manufacture.</p>
            </div>
            
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-white mb-3">Completed Operations</h3>
              <p className="text-gray-300">Protection for liability arising from completed work or services.</p>
            </div>
          </div>
        </div>
      </section>
